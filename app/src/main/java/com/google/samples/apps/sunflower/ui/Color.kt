...
val md_theme_light_inversePrimary = Color(0xFFB867DA)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF541F75)
val md_theme_light_outlineVariant = Color(0xFFC3C8BB)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFA95FC9)
val md_theme_dark_onPrimary = Color(0xFF4D1C6B)
val md_theme_dark_primaryContainer = Color(0xFF692992)
val md_theme_dark_onPrimaryContainer = Color(0xFFC66DEE)
val md_theme_dark_secondary = Color(0xFFBCCBB0)
val md_theme_dark_onSecondary = Color(0xFF273421)
val md_theme_dark_secondaryContainer = Color(0xFF481A64)
...
val md_theme_dark_inversePrimary = Color(0xFF7070A6)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFFC56DED)
val md_theme_dark_outlineVariant = Color(0xFF43483E)
val md_theme_dark_scrim = Color(0xFF000000)

val seed = Color(0xFF9C27B0)
